...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Registro(RegistroViewModel modelo)
        {
            ...
            var resultado = await userManager.CreateAsync(user, password: modelo.Password);
        ...
        public ChallengeResult LoginExterno(string proveedor, string urlRetorno = null)
        {
            ...
            var propieddaes = signInManager.ConfigureExternalAuthenticationProperties(proveedor, urlRedireccion);
            return new ChallengeResult(proveedor, propieddaes);
        }
